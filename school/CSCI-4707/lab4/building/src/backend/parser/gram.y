...
/* Modifications made by Russell and Gavin to add IGNORE */
%token <keyword> ABORT_P ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER*/
	...
	IDENTITY_P IGNORE IF_P ILIKE IMMEDIATE IMMUTABLE IMPLICIT_P IN_P
 ...
 *	2002-08-28 bjm
 *
 * Additional modifications made to add IGNORE, based off of OFFSET
 */
select_no_parens:
			simple_select						{ $$ = $1; }
